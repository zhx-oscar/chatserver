...
# 使用方法
## 启动服务端
1. cd 到 chatserver/server/src目录下
2. 输入make指令
3. cd 到 chatserver/server/bin目录下
4. 执行./chat_server -h 可查看参数
```
...
```
5. 使用./chat_server 加参数启动或者直接启动
## 启动客户端
1. cd 到 chatserver/client/src目录下
2. 输入make指令
3. cd 到 chatserver/client/bin目录下
4. 执行./chat_client -h 可查看参数
```
